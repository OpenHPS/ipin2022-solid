...
const floor = new Floor("PL9.3").setUID("deployment_pl9_3")
    ...
    .setFloorNumber(3);
const office1 = new Room("PL9.3.60").setUID("deployment_pl9_3_60")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(0.57, 31.25),
        new Absolute2DPosition(4.75, 37.02),
    ]);
const office2 = new Room("PL9.3.58").setUID("deployment_pl9_3_58")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(4.75, 31.25),
        new Absolute2DPosition(8.35, 37.02),
    ]);
const office3 = new Room("PL9.3.56").setUID("deployment_pl9_3_56")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(8.35, 31.25),
        new Absolute2DPosition(13.15, 37.02),
    ]);
const office4 = new Room("PL9.3.32").setUID("deployment_pl9_3_32")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(29.97, 31.25),
        new Absolute2DPosition(34.77, 37.02),
    ]);
const lab = new Room("PL9.3.54").setUID("deployment_pl9_3_54")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(13.15, 31.25),
        new Absolute2DPosition(25.15, 37.02),
    ]);
const classroom = new Room("PL9.3.62").setUID("deployment_pl9_3_62")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(27.55, 24.105),
        new Absolute2DPosition(35.95, 29.5),
    ]);
const hallway = new Corridor("Corridor").setUID("deployment_pl9_3_corridor")
    .setFloor(floor)
    .setBounds([
...
const lobby = new Zone("Lobby #1").setUID("deployment_pl9_3_lobby_1")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(20.315, 20.155),
        new Absolute2DPosition(25.765, 27.27)
    ]);
const lobby2 = new Zone("Lobby #2").setUID("deployment_pl9_3_lobby_2")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(18.015, 0.57),
        new Absolute2DPosition(20.315, 6.015)
    ]);
const toilet1 = new Zone("Toilets #1").setUID("deployment_pl9_3_toilets_1")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(15.48, 10.51),
        new Absolute2DPosition(18.015, 12.71),
    ]);
const toilet2 = new Zone("Toilets #2").setUID("deployment_pl9_3_toilets_2")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(15.48, 24.56),
        new Absolute2DPosition(18.015, 26.76),
    ]);
const elevators = new Corridor("Elevators").setUID("deployment_pl9_3_elevators")
    .setFloor(floor)
    .setBounds([
        new Absolute2DPosition(10.73, 17.22),
        new Absolute2DPosition(18.02, 20.06),
    ]);
const stairs = new Corridor("Staircase").setUID("deployment_pl9_3_staircase")
    .setFloor(floor)
    .setBounds([
